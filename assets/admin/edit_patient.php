...
if(isset($_POST["edit"])){
  ...
  $gender = $_POST["gender"];
    ...
    $update = "UPDATE `patient` SET `name` = '$name', `email` = '$email', `password` = '$password', `phone` = $phone, `age` = $age, `gender` = '$gender', `mental_test_score` = $mental WHERE id = $patientId";
                      ...
                      <div class="modal-body">
                        <form method="POST">
                          <input
                            ...
                            name="name"
                            id=""
                            value="<?php echo $patientRow["name"]; ?>"
                          />
                          <br />
                          <input
                            type="email"
                            ...
                            name="email"
                            id=""
                            value="<?php echo $patientRow["email"]; ?>"
                          />
                          <br />
                          <input
                            type="number"
                            ...
                            name="phone"
                            id=""
                            value="<?php echo $patientRow["phone"]; ?>"
                          />
                          <br />
                          <input
                            type="number"
                          ...
                          <input
                            ...
                            name="password"
                            id=""
                            value="<?php echo $patientRow["password"]; ?>"
                          />
                          <br />
                          <input
                            type="text"
                            ...
                            name="gender"
                            id=""
                            value="<?php echo $patientRow["gender"]; ?>"
                          />

                          <br />
                          <input
                            type="number"
                            placeholder="mental test score"
                            class="form-control"
                            name="mental"
                            id=""
                            value="<?php echo $patientRow["mental_test_score"]; ?>"
                          />
