...
if(isset($_GET["delete"])){
  ...
  $selectDeleted = "DELETE FROM `feedbacks` WHERE id = $deletedId";
  $deleteQuery = mysqli_query($conn, $selectDeleted);
  header("Location: ./all_feedbacks.php");
}


$selectFeedbacks = "SELECT * FROM `feedbacks` ORDER BY id DESC";
$feedbacksQuery = mysqli_query($conn, $selectFeedbacks);
      ...
      >
        ...
        <li class="nav-item active">
          <a class="nav-link" href="./all_patients.php">
            <span>all patient</span></a
          >
        </li>

        <li class="nav-item active">
          <a class="nav-link" href="./all_therapists.php">
            <span>all therapist</span></a
          >
        </li>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php foreach($feedbacksQuery as $feedback){ ?>
                        <tr>
                          <td><?php echo $feedback["id"]; ?></td>
                          <td><?php echo $feedback["patient_id"]; ?></td>
                          <td><?php echo $feedback["therapist_id"]; ?></td>
                          <td><?php echo $feedback["feedback"]; ?></td>
                          <td><?php echo $feedback["rate"]; ?></td>
                        <td>
                        <a href="./all_feedbacks.php?delete=<?php echo $feedback["id"]; ?>" onclick="return confirm('Are you sure you would like to delete this feedback?')" class="btn btn-danger">Delete</a>
                      </td>
                      </tr>
                      <?php } ?>
                    </tbody>
