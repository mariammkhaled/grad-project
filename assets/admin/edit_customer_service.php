...
if(isset($_GET["worker"])){
  $selectWorker = "SELECT * FROM `customer_service` WHERE id = $workerId";
...
if(isset($_POST["edit"])){
  ...
  $nid = $_POST["nid"];
    ...
    $update = "UPDATE `customer_service` SET `name` = '$name', email = '$email', `password` = '$password', `phone` = $phone, `acc_number` = $acc_number, `age` = $age, `gender` = '$gender', `nid` = $nid WHERE id = $workerId";
                      ...
                      <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data">
                          ...
                          <input
                            ...
                            name="email"
                            id=""
                            value="<?php echo $workerRow["email"]; ?>"
                          />
                          <br />
                          <input
                            type="number"
                            ...
                            name="phone"
                            id=""
                            value="<?php echo $workerRow["phone"]; ?>"
                          />
                          <br />
                          <input
                            type="number"
                            ...
                            name="acc_number"
                            id=""
                            value="<?php echo $workerRow["acc_number"]; ?>"
                          />
                          <br />
                          <input
                            type="number"
                          ...
                          <input
                            ...
                            name="password"
                            id=""
                            value="<?php echo $workerRow["password"]; ?>"
                          />
                          <br />
                          <input
                            type="text"
                            ...
                            name="gender"
                            id=""
                            value="<?php echo $workerRow["gender"]; ?>"
                          />
