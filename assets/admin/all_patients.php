...
if(isset($_GET["search"])){
  $search = $_GET["search"];
  $selectedPatients = "SELECT * FROM `patient` WHERE `name` or `email` like'%$search%'  ORDER BY id DESC";
  $patientsQuery = mysqli_query($conn, $selectedPatients);  
}else{
  $selectedPatients = "SELECT * FROM `patient` ORDER BY id DESC";
  $patientsQuery = mysqli_query($conn, $selectedPatients);
}
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">age</th>
                        <th scope="col">mental test id</th>
                        <th scope="col">gender</th>
                        <th scope="col" style="text-align:center;" colspan="2">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php foreach($patientsQuery as $patient){ ?>
                        <tr>
                          ...
                          <td><?php echo $patient["mental_test_score"]; ?></td>
                          <td><?php echo $patient["gender"]; ?></td>
                          
                        <td>
                        <a href="./edit_patient.php?patient=<?php echo $patient["id"]; ?>" class="btn btn-success">Edit</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
