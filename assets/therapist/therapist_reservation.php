...
$reservationsInfo = "SELECT * FROM `reservations` WHERE `therapist_id` = $therapistId ORDER BY id DESC";
$reservationsQuery = mysqli_query($conn, $reservationsInfo);
